...
//Last modified: Sun, Feb 25, 2024 09:01:24 PM
//Codeset: 1252
requires maya "2024";
...
fileInfo "UUID" "7D963DF4-4340-3A49-3E25-55959248A447";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "5A3E4AE2-46F0-0794-1CA7-35867651B559";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "BF83B414-430C-4690-14D4-F4B7DF81485B";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "79C832EE-44FD-1DDA-F009-5788647793E0";
createNode displayLayerManager -n "layerManager";
	rename -uid "6FDB9247-4CE0-0490-26CC-A8A3C7B4F987";
createNode displayLayer -n "defaultLayer";
	rename -uid "CE1AB878-4592-F4D9-FF5A-2BBBA6DE80D0";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "A495FE5D-4EF7-056D-FBC1-BB84CDA61EE5";
...
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "864466E1-4BDD-CB4D-116E-2EA28DBD8AFC";
