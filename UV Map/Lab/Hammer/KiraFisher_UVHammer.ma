...
//Last modified: Thu, Feb 29, 2024 04:20:45 PM
//Codeset: 1252
requires maya "2024";
...
fileInfo "UUID" "EB85120C-4A01-BEF7-CCED-7C8AF86FFFB2";
fileInfo "license" "education";
createNode transform -s -n "persp";
	rename -uid "D9FAA5E2-404B-40B0-65DF-60B6CADA10D3";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 15.720198289377763 63.340856350001012 98.528623808264797 ;
	setAttr ".r" -type "double3" 332.53561031717152 1.7999999999989438 359.99999999997777 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "A6152324-45C4-E649-28D9-45BFDB81F78C";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "117B6846-4544-B454-2778-B894EC82606F";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "5FB77ADC-4D87-4479-B9CE-CE8A2AFBEDBD";
createNode displayLayerManager -n "layerManager";
	rename -uid "FE09F3BE-4B8F-AACA-6887-BF91063096EA";
createNode displayLayer -n "defaultLayer";
	rename -uid "CE1AB878-4592-F4D9-FF5A-2BBBA6DE80D0";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "33B76510-4A38-766D-5569-FEBE0C034E58";
...
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "340165B3-4819-A62D-0F88-42901B933852";
